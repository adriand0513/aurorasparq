...
import random
import time
import logging# main.py - Clean & Stable Isabella Chatbot
import os
import logging
...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=8000, reload=True, log_level="info")# main.py - Isabella Chatbot Server (Open, Anonymous, Render-Ready)
import os
import re
import json
import random
